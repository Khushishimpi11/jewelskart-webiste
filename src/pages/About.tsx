  ...
  return (
    <div className="min-h-screen bg-white text-foreground">
      ...
      <main className="pt-16 lg:pt-24">
        {/* Banner Section - Original InnerPageBanner */}
        <InnerPageBanner
          title="About Us"
          subtitle="Our Legacy"
          breadcrumbs={[
              ...
              >
                ...
                <p className="text-muted-foreground leading-relaxed mb-6 flex items-start gap-2 text-lg">
                  <span>
                    ...
                    he carries a vision of delivering purity, craftsmanship, and trust.
                  </span>
                </p>

                <p className="text-muted-foreground leading-relaxed flex items-start gap-2 text-lg">
                  <span>
                    Born into a jewellery legacy, he officially established the brand in 1990
                    to preserve family values of trust and purity, while introducing modern
                    innovation and refined customer experience.
                  </span>
                </p>
              </motion.div>
              ...
              >
                ...
                <ul className="space-y-4 text-muted-foreground">
                  ...
                  <li className="flex items-center gap-2">
                    ...
                    Customer Relationships Built Over Generations
                  </li>
                </ul>
              </motion.div>
            </div>
