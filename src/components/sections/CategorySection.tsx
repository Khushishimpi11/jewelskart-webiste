    ...
    <section className="py-10 sm:py-16 lg:py-24 bg-background overflow-hidden">
      <div className="container mx-auto px-4 lg:px-8">
        ...
        >
          ...
          <h2 className="font-display text-2xl sm:text-4xl md:text-5xl text-foreground mt-3 sm:mt-4 mb-2 sm:mb-3">
            Our Collections
          </h2>
          <p className="text-foreground/60 text-sm sm:text-lg max-w-2xl mx-auto mb-3 sm:mb-4">
          ...
          <div className="flex gap-4 sm:gap-6 animate-marquee hover:pause">
            {[...categories, ...categories, ...categories].map((category, index) => (
              <Link
                ...
                className="group flex-shrink-0 w-56 sm:w-72 lg:w-96"
              >
                <motion.div
                  whileHover={{ y: -8 }}
                ...
                >
                  ...
                  <div className="absolute bottom-0 left-0 right-0 p-4 sm:p-6">
                    <h3 className="font-display text-xl sm:text-3xl text-white mb-1">
                      {category.name}
                    </h3>
                    <p className="text-white/80 text-xs sm:text-sm mb-2 sm:mb-3">
                      {category.productCount} pieces
                    </p>
                    <span className="inline-flex items-center bg-primary text-white text-xs sm:text-sm font-body tracking-wider uppercase px-2 sm:px-3 py-1 rounded-full backdrop-blur-sm">
                      Explore Collection
                    </span>
                  </div>
                </motion.div>
