        ...
        <div className="lg:col-span-4 text-center lg:text-left z-10 lg:pl-8">
          <div className="mb-6 flex justify-center lg:justify-start">
            <span className="inline-flex items-center bg-primary text-white px-4 py-2 font-body text-[10px] tracking-[3px] uppercase rounded-full shadow-md">
              <img src={exploreIcon} alt="Explore" className="w-4 h-4 sm:w-5 sm:h-5 mr-2 object-contain" />
            ...
            >
              <div className="relative bg-white aspect-[4/5] overflow-hidden mb-4 border border-gray-50">
                ...
                <div className="absolute inset-0 bg-black/20 opacity-0 group-hover:opacity-100 transition-all duration-300 flex items-center justify-center gap-3">
                  <button onClick={(e) => handleAddToCart(product, e)} className="bg-white p-2.5 rounded-full hover:bg-blue-500 hover:text-white transition-all duration-300 shadow-md transform hover:scale-110"><ShoppingCart size={18} /></button>
                  <button onClick={(e) => handleQuickView(product, e)} className="bg-white p-2.5 rounded-full hover:bg-green-500 hover:text-white transition-all duration-300 shadow-md transform hover:scale-110"><Eye size={18} /></button>
                  <button onClick={(e) => handleWishlist(product, e)} className="bg-white p-2.5 rounded-full hover:bg-red-500 hover:text-white transition-all duration-300 shadow-md transform hover:scale-110"><Heart size={18} /></button>
                </div>
              </div>
          ...
          <div className="relative w-full max-w-[500px] aspect-[10/13] group">
            ...
            <svg viewBox="0 0 500 300" className="absolute top-[20px] left-0 w-full overflow-visible pointer-events-none z-30">
              ...
              <text fill="white" fontSize="28" className="font-serif italic" letterSpacing="1">
                <textPath href="#archPathBottomFixed" startOffset="50%" textAnchor="middle">Elegance In Every Detail</textPath>
              </text>
            </svg>
            <button 
              onClick={() => navigate("/shop")}
