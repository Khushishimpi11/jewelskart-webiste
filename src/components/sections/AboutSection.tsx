...
export const AboutSection = () => {
  ...
  return (
    <section className="py-12 sm:py-16 md:py-24 lg:py-32 relative overflow-hidden" style={{ backgroundColor: '#FBF5F6' }}>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 sm:gap-16 lg:gap-24 items-center">
          ...
          >
            <div className="flex justify-center lg:justify-start">
              <span className="inline-flex items-center bg-primary text-white rounded-full px-5 sm:px-6 py-2 sm:py-2.5 font-body text-[10px] sm:text-sm tracking-[0.2em] uppercase mb-4 sm:mb-6 shadow-md">
                <img 
                  src={exploreIcon} 
                  alt="Explore" 
